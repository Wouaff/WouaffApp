        ...
        {results.map((user, i) => {
          ...
          return (
            <li key={user.uid}>
              ...
              >
                <div className="w-9 h-9 rounded-full bg-gradient-to-br from-brand to-brand-dark flex items-center justify-center text-[var(--brand-ink)] font-bold text-sm overflow-hidden flex-shrink-0">
                  {user.avatar ? (
                    <img
                      src={user.avatar}
